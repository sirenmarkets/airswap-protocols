...
export class MerkleTree {
  ...
  public combinedHash(first, second) {
    if (!first) {
      return second
    }
    if (!second) {
  ...
  public getPairElement(idx, layer) {
